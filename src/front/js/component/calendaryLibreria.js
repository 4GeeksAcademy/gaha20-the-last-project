...
class calendaryLibreria extends Component {
  constructor(props) {
    super(props);
    moment.locale("es");
    ...
    this.state = {
      ...
      mostrarComponenteExterno: false,
      prop1: "Valor1",
      prop2: "Valor2",
      court: "",
      startDate: null,
  ...
  render() {
    ...
    return (
      <div>
        <div>
          <h3 style={{ textAlign: "center" }}>Court Scheduler</h3>
          <Scheduler
        ...
        {mostrarComponenteExterno && (
          <CourtScheduleAdminForm
            isVisible={mostrarComponenteExterno}
            setIsVisible={this.setIsVisible1}
            startDate={startDate}
            court={court}
  ...
  setIsVisible1 = (valor) => {
    this.setState({ mostrarComponenteExterno: valor });
  };
  ...
  slotClickedFunc = (schedulerData, slot) => {
    ...
    // );
    this.setState({ mostrarComponenteExterno: true });
    this.setState({
      prop1: "NuevoValor1",
      prop2: "NuevoValor2",
    });
...
export default DragDropContext(HTML5Backend)(calendaryLibreria);
